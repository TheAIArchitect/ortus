...
void newPTCB(btDynamicsWorld* world, btScalar timeStep){
    std::unordered_map<std::string,float> theseActivationsGJ = DataSetup::muscleActivationsGJ[muscleActivationsIndex];
    std::unordered_map<std::string,float> theseActivationsCS = DataSetup::muscleActivationsCS[muscleActivationsIndex];
