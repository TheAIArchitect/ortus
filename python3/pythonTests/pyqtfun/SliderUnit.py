...
class SliderUnit(QWidget):
    ...
    valueChangeSignal = pyqtSignal(float)
    ...
    def __init__(me, paramName, paramMin = 0, paramMax = 100):
        super().__init__()
    ...
    def convertFromValueBox(me, displayValueString):
        try:
            displayValue = int(displayValueString)
        except ValueError:
            return False 
    ...
    def updateParameterValue(me, value):
        ...
        me.valueChangeSignal.emit(me.paramValue)
