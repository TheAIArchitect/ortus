...
\begin{outline}
    \point Titles:
        \subpoint Ortus: Pioneering (artificial)  Biological Intelligence
            \subsubpoint \ldots that one is a bit bold
        \subpoint Ortus: An Approach to (artificial) Biological Intelligence
        \subpoint Ortus: Approaching (artificial) Biological Intelligence
        \subpoint Ortus: Emotionally Approaching (artificial) Biological Intelligence 
        \subpoint Ortus: Introducing an Emotionally Driven Approach to (artificial) Biological Intelligence
        \subpoint Ortus: an Emotionally--Driven Approach to (artificial) Biological Intelligence
        \subpoint Ortus: Emotionally--Driven (artificial) Biological Intelligence
        \subpoint An Approach to Emotionally--Driven (artificial) Biological Intelligence
        \subpoint Ortus: A Simple Virtual Brain With Emotionally Driven Learning
        \subpoint Ortus: Toward a Virtual Brain
\end{outline}
